          ...
          >
            <div className="p-2 h-full">
              <div className="flex h-full justify-start px-4 w-[300px] items-center bg-custom-green-30 text-custom-green-dark font-semibold rounded-[5px]">
                <i className="bi bi-folder mr-3 text-[18px] flex justify-center items-center"></i>
            ...
            <div className="p-2 h-full hidden md:flex">
              <div className="flex h-full px-4 w-[275px]  items-center justify-between bg-custom-green-30 text-custom-green-dark font-semibold rounded-[5px]">
                <div className="flex">
                <i className="bi bi-calendar4-week mr-3 text-[18px] flex justify-center items-center"></i>
                <p>{project.deadline}</p>
                </div>
                <p className={`flex justify-center items-center whitespace-nowrap px-2 py-1 rounded-[5px] w-[105px] ${ Math.ceil( (new Date(project.deadline) - new Date()) / (1000 * 60 * 60 * 24) ) < 0 ? "text-white bg-red-700" : "text-white bg-custom-green-dark"}`} >
            ...
            <div className="p-2 h-full hidden lg:flex">
              <div className="flex h-full justify-start px-4 w-[195px] items-center bg-custom-green-30 text-custom-green-dark font-semibold rounded-[5px]">
                <i className="bi bi-people mr-3 text-[18px] flex justify-center items-center"></i>
