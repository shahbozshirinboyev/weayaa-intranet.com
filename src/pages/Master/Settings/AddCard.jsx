...
export default function AddCard() {
  ...
  return (
    <>
      <button
        onClick={() => document.getElementById("addCardModal").showModal()}
        className="rounded-[5px] flex justify-center items-center w-full h-full"
      >
      ...
      <div className="modal-box max-w-lg p-0">
          ...
          >
            <span className="text-custom-green-dark font-bold">Add Card</span>
